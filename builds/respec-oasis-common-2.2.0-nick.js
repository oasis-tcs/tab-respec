/* ReSpec 2.2.0-nick - Robin Berjon, http://berjon.com/ (@robinberjon)
...
define(
    'core-style',["text!css/respec2.css"],
    function (css) {
        return {
            run:    function (conf, doc, cb, msg) {
...
define(
    'oasis-style',["text!css/default.css"],
    function (css) {
        return {
            run:    function (conf, doc, cb, msg) {
    ...
    function (hb, utils, N3, vocabTmpl) {
        return {
            ...
            vocabToSpec: function(util, content) {
                ...
                var rdfResource = "http://www.w3.org/2000/01/rdf-schema#Resource";
